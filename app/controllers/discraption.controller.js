    ...
    question: [
      {
        ...
        questionText: req.body.questionText ? req.body.questionText : "questionText",
        definition: req.body.definition ? req.body.definition : "definition",
      },
    ],
  });
...
exports.deleteAll = (req, res) => {
  Discraption.deleteMany({})
    ...
    .catch((err) => {
      res.status(500).send({
        message:
          err.message || 'Some error occurred while removing all Discraptions.',
      });
    });
};
...
exports.findAllPublished = (req, res) => {
  ...
  Discraption.find({ published: true }, selectedData)
    ...
    .catch((err) => {
      res.status(500).send({
        message:
          err.message || 'Some error occurred while retrieving Discraptions.',
      });
    });
};
